...
out_file="$out_dir/nsatmos_6.05_9090_mono.txt"
beaming=3      # NSATMOS hydrogen
...
out_file="$out_dir/nsatmos_6.05_9090_inte.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0967 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
...
out_file="$out_dir/nsatmos_6.05_3080_mono.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0967 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
...
out_file="$out_dir/nsatmos_6.05_3080_inte.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0967 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
out_file="$out_dir/nsatmos_6.3_9090_mono.txt"
beaming=3      # NSATMOS hydrogen
temp=0.172 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
emission=90 # in degrees
spectraltype=0 # Monochromatic
...
out_file="$out_dir/nsatmos_6.3_9090_inte.txt"
beaming=3      # NSATMOS hydrogen
temp=0.172 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
...
out_file="$out_dir/nsatmos_6.3_3080_mono.txt"
beaming=3      # NSATMOS hydrogen
temp=0.172 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
out_file="$out_dir/nsatmos_6.3_3080_inte.txt"
beaming=3      # NSATMOS hydrogen
temp=0.172 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
out_file="$out_dir/nsatmos_5.69_9090_mono.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0422 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
emission=90 # in degrees
spectraltype=0 # Monochromatic
...
out_file="$out_dir/nsatmos_5.69_9090_inte.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0422 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
...
out_file="$out_dir/nsatmos_5.69_3080_mono.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0422 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
out_file="$out_dir/nsatmos_5.69_3080_inte.txt"
beaming=3      # NSATMOS hydrogen
temp=0.0422 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
