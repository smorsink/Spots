...
# TEST 1: McPHAC, 1.1e6K, 90/90, monochromatic
...
# TEST 2: McPHAC, 1.1e6K, 90/90, integrated
...
# TEST 3: McPHAC, 1.1e6K, 30/80, monochromatic
...
# TEST 4: McPHAC, 1.1e6K, 30/80, integrated
...
# TEST 5: McPHAC, 2e6K, 90/90, monochromatic
out_file="$out_dir/mcphac_6.3_9090_mono.txt"
beaming=8      # mcphac
...
# TEST 6: McPHAC, 2e6K, 90/90, integrated
out_file="$out_dir/mcphac_6.3_9090_inte.txt"
beaming=8      # mcphac
temp=0.1758 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
...
# TEST 7: McPHAC, 2e6K, 30/80, monochromatic
out_file="$out_dir/mcphac_6.3_3080_mono.txt"
beaming=8      # mcphac
temp=0.1758 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
# TEST 8: McPHAC, 2e6K, 30/80, integrated
out_file="$out_dir/mcphac_6.3_3080_inte.txt"
beaming=8      # mcphac
temp=0.1758 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
# TEST 9: McPHAC, 5e5K, 90/90, monochromatic
out_file="$out_dir/mcphac_5.69_9090_mono.txt"
beaming=8      # mcphac
...
# TEST 10: McPHAC, 5e5K, 90/90, integrated
out_file="$out_dir/mcphac_5.69_9090_inte.txt"
beaming=8      # mcphac
temp=0.042 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=90 # in degrees
...
# TEST 11: McPHAC, 5e5K, 30/80, monochromatic
out_file="$out_dir/mcphac_5.69_3080_mono.txt"
beaming=8      # mcphac
temp=0.042 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
...
# TEST 12: McPHAC, 5e5K, 30/80, integrated
out_file="$out_dir/mcphac_5.69_3080_inte.txt"
beaming=8      # mcphac
temp=0.042 # in keV (Surface temperature)
inst_res=2     # 1 cm^2 for all bands
inclination=30 # in degrees
