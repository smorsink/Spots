2017 May 24 - WCG Ho -- 2020 Update!

*** Note that the atmosphere file is too large to store on GitHub!
*** Files are stored on Dropbox instead
*** look in ~/code/atmosphere

Format similar to that used for Xspec models NSX, NSMAXG, NSATMOS, and NSA.

First 8 rows:
Row 1: = 35, number of effective temperatures NlogTeff
Row 2: logTeff (K) = 5.1,5.2,...,6.5
Row 3: = 14, number of surface gravities Nlogg
Row 4: logg (cm s^-2) = 13.7,13.8,...,14.7
Row 5: = 166, number of photon energies NlogE
